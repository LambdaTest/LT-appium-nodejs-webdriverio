...
- Follow the [Run Appium tests with WebdriverIO on TestMu AI](https://www.testmuai.com/support/docs/appium-nodejs-webdriverio/) for the full setup walkthrough.
